...
const IDEStyleContactCard = () => {
  ...
  return (
    <div className="w-full h-[78%] mx-auto">
      <div className="bg-gray-800 h-[550px] rounded-2xl shadow-lg overflow-hidden">
        ...
        <div className="flex h-[calc(100%-40px)]">
          <div className="w-1/2 p-4 font-mono text-lg text-cyan-400 border-r border-gray-700">
            ...
            <div className="pl-4 space-y-4">
              <div>
                <label htmlFor="name" className="block text-gray-400 mb-1">_Name:</label>
                <input
                  type="text"
                  id="name"
                  name="name"
              ...
              <div>
                <label htmlFor="email" className="block text-gray-400 mb-1">_Email:</label>
                <input
                  type="email"
                  id="email"
                  name="email"
              ...
              <div>
                <label htmlFor="message" className="block text-gray-400 mb-1">_Message:</label>
                <textarea
                  id="message"
                  name="message"
          ...
          <div className="w-1/2 p-4 font-mono text-lg text-cyan-400">
            <p className="mb-4">
              <span className="text-pink-400">const</span>{' '}
